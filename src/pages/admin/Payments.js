...
import { pink, teal, indigo, orange, deepPurple } from '@mui/material/colors';
              ...
              <Table>
                <TableHead>
                  <TableRow sx={{ backgroundColor: 'primary.light' }}>
                    <TableCell sx={{ color: 'common.white', fontWeight: 'bold' }}>User</TableCell>
                    <TableCell sx={{ color: 'common.white', fontWeight: 'bold' }}>Certificate #</TableCell>
                    <TableCell sx={{ color: 'common.white', fontWeight: 'bold' }}>Control #</TableCell>
                    <TableCell sx={{ color: 'common.white', fontWeight: 'bold' }}>Amount</TableCell>
                    <TableCell sx={{ color: 'common.white', fontWeight: 'bold' }}>Method</TableCell>
                    <TableCell sx={{ color: 'common.white', fontWeight: 'bold' }}>Status</TableCell>
                    <TableCell sx={{ color: 'common.white', fontWeight: 'bold' }}>Payment Date</TableCell>
