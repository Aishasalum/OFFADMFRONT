...
//   const fetchRecords = () => {
//     axios.get('http://localhost:8080/api/birth-records')
...
//     e.preventDefault();
//     if (editingId) {
//       axios.put(`http://localhost:8080/api/birth-records/${editingId}`, formData)
//         .then(() => {
...
//         });
//     } else {
//       axios.post('http://localhost:8080/api/birth-records', formData)
//         .then(() => {
//           setFormData(initialFormData());
//           fetchRecords();
//         });
...
//       axios.delete(`http://localhost:8080/api/birth-records/${id}`)
//         .then(() => fetchRecords());
//     }
//   };
